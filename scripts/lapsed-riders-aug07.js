// Lapsed riders as of 2026-08-07. Cutoff = 8 weeks back = 2026-06-12
// node scripts/lapsed-riders-aug07.js
...
const CUTOFF_DATE = new Date('2026-06-12') // 8 weeks before 2026-08-07
...
async function main() {
  ...
  console.log('\nAll lapsed:')
  lapsed.forEach((r, i) => {
    console.log(` ${i+1}. [${r.isRepeat?'REPEAT':'once '}] ${(r.name||'').padEnd(25)} rides:${r.rideCount} last:${r.lastRide} phone:${r.phone||'none'} email:${r.email||'none'}`)
  })

  const out = 'C:/Users/jacob/OneDrive/Desktop/lapsed-riders-2026-08-07.json'
