...
// GET /api/loop-admin/scoreboard — code-gated. The Loop (Marines) leadership
// scoreboard. Mirrors lib/leadershipHome but for kind='marines':
...
// so a $0 comp doesn't inflate dollars — same rule as /api/loop-admin/revenue.
...
// Tally Single/Day/total + revenue over a set of paid marines orders.
...
export async function GET() {
  ...
  // --- cumulative: all-time paid marines orders ---
  ...
  // Weekend = paid marines orders on the active group's event(s).
