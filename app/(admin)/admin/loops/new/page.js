import EventForm from '../../groups/EventForm'
...
export default function NewLoopPage() {
  return (
    <main style={{ maxWidth: 700, margin: '0 auto', padding: '20px 16px', minHeight: '100vh', color: '#fff' }}>
      <a href="/admin/loops" style={{ color: '#d4a333', fontSize: 13, textDecoration: 'none' }}>← All Loops</a>
      ...
      <EventForm mode="create" groupBasePath="/admin/loops" />
    </main>
  )
}
