...
// own group with its own ordered stop set and per-stop pricing. Stops are
// first-class: pick a bar (or type a name), set time, price, optional capacity +
// coords. Loads/saves via /api/admin/loops. This is the capability Brew's rigid
// "clone last weekend" builder lacks.

// HUD palette — matches the rest of the /admin console (black + gold).
const C = {
  LINE: '#2a2a31',
  GOLD: '#d4a333',
  GOLD_HI: '#f0c24a',
