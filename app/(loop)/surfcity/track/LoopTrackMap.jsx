...
// Live map for the Surf City Loop. Fork of the Marines LoopTrackMap with no
// behavioral deltas: (1) it polls /api/shuttle/current scoped to its own
// group_id so it shows the Surf shuttle, never the Brew or Marines bus; (2) it
// draws the loop polyline connecting the stops in order; (3) gold accent +
// a plain marker. ETA + StopList logic is unchanged.
