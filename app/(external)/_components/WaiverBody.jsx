...
// Shared waiver-landing body for Brew ('/waiver') and Surf City
// ('/surfcity/waiver'). The real waiver is a per-contact link texted after
// booking; this page just helps riders find it.
...
export default function WaiverBody({ business = 'brew' }) {
    ...
    <main>
        ...
        >
          ...
          <p style={{ marginTop: 28, fontSize: 13, color: 'rgba(255,255,255,0.5)' }}>
            Haven&apos;t booked yet? <a href={prefixLink('/events', business)} style={{ color: GOLD, textDecoration: 'none', fontWeight: 600 }}>See upcoming loops &rarr;</a>
          </p>
        </section>
    </main>
  )
