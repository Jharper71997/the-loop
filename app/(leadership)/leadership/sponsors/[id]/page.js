            ...
            <tbody>
              {payments.map(p => (
                <tr key={p.id} style={{ borderBottom: '1px solid #2a2a31' }}>
                  ...
                  <td style={{ ...td, textAlign: 'right', fontFamily: "'Orbitron', system-ui, sans-serif", fontWeight: 700 }}>{formatCents(p.amount_cents)}</td>
                </tr>
              ))}
            </tbody>
          </table>
...
function Stat({ label, value }) {
  return (
    <div style={{
      ...
      <div style={{ fontFamily: "'Orbitron', system-ui, sans-serif", fontSize: 18, fontWeight: 800, color: '#e8e8ea' }}>
        {value}
      </div>
    </div>
  )
...
const titleStyle = { color: '#d4a333', fontFamily: "'Orbitron', system-ui, sans-serif", fontSize: 22, letterSpacing: '0.18em', textTransform: 'uppercase', margin: 0, textShadow: '0 0 14px rgba(212,163,51,0.45)' }
const subtitleStyle = { color: '#9c9ca3', fontSize: 11, letterSpacing: '0.18em', textTransform: 'uppercase', margin: '6px 0 0 0' }
...
const sectionHeader = { color: '#e8e8ea', fontFamily: "'Orbitron', system-ui, sans-serif", fontSize: 13, letterSpacing: '0.22em', textTransform: 'uppercase', margin: '0 0 12px 0', borderBottom: '1px solid #2a2a31', paddingBottom: 6 }
