...
// Returns the verified session email, or null if there is no session. Unlike
// the denyIfNot* helpers this doesn't build a Response — use it on routes that
// are public by design but accept a privileged field, where the right answer is
// "ignore the field", not "reject the request".
...
// Alias used by the SMS inbox routes to attribute staff replies.
export const currentUserEmail = sessionEmail
