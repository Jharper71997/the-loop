...
// hardcoded number. The `partner-8` row is an unfilled placeholder, so the real
// public count is currently one less than this array's length.
//
...
// thing the bar is known for. (Archie's Nickel Night is real; it still can't go
// here.) These blurbs render publicly on /bars, /bars/[slug] and the homepage.
