...
export const BARS = [
  {
    ...
    description:
      "A veteran-owned Irish pub that has been on Gum Branch Road since 2015, serving Irish and American pub food with darts, pool, karaoke, trivia and live music through the week. The Garden Pavilion out back opened in 2018 as a separate open-air room with its own menu, and it runs Friday and Saturday nights, which is exactly when the Loop comes through.",
  ...
  },
  {
    ...
    description:
      "The oldest bar in Jacksonville, open since 1952. It is a neighborhood room first: games on the TVs, darts and billiards in the back, karaoke when the mood takes it, and a regular crowd that will talk to you whether you planned on it or not.",
  ...
  },
  {
    ...
    name: 'Archies Pub',
    neighborhood: 'Jacksonville, NC',
    blurb: 'Veteran-owned neighborhood pub on Lejeune, pool tables and a jukebox.',
    description:
      "A veteran-owned neighborhood pub on Lejeune Boulevard with an Irish streak and no pretense about it. Three pool tables, an electronic dart board, foosball, and a jukebox that will play anything you ask it to. Doors open at 7.",
  ...
  },
  {
    ...
    description:
      "Locally owned and run since 1986, and the room Jacksonville goes to for karaoke, which runs here every single night. Fourteen flat screens and a 100-inch projector cover the games, with darts and pool for everyone who is not singing.",
  ...
  },
  {
    ...
    description:
      "A Nordic-themed tavern that bills itself as the only Viking bar in North Carolina, and decorates like it means it. Small, deliberately laid-back, and openly built around the local military community, with pool tables, dart boards and live music on the calendar.",
  ...
  },
  {
    ...
    neighborhood: 'Jacksonville, NC',
    blurb: 'Games-first tavern in Midway Park, with karaoke on Saturday nights.',
    description:
      "Out on Freedom Way in Midway Park, in a building that was a laundromat in a previous life. Open since 2014 and built around games, pool and darts and cornhole, with karaoke on Saturday nights and a running calendar of poker nights and potlucks that the regulars actually turn up for.",
  ...
  },
  {
    ...
    neighborhood: 'Jacksonville, NC',
    blurb: 'Bar and grill on Onslow Drive, with a real kitchen behind it.',
    description:
      "A full bar and grill on Onslow Drive, running on the motto “come as you are, leave completely unhinged.” There is a real kitchen behind it, and the Straight Jacket burger and the Boom Boom Shrimp are what they are known for, plus screens for game day and live entertainment.",
  ...
  },
  {
    ...
    description:
      "A Mexican kitchen on Western Boulevard from restaurateurs who have done this before, built loud and social on purpose. Tacos are the point, ribeye and shrimp and fish, alongside Mexican-inspired plates and seafood. There is private event space too, if your group outgrows a table.",
