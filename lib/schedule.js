...
// "Operational" date for night-of-Loop surfaces: returns the previous calendar
// date until local time passes the cutoff hour (default 3 AM). Friday's Loop
// stays "tonight" through 2:59 AM Saturday so the admin can still text the
// group after the bars close. Don't use this for rider-facing surfaces — the
// public site should roll over at midnight.
