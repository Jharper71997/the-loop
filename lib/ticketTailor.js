...
async function upsertContact(supabase, r) {
  // Phone-required: a rider without a phone is unreachable for SMS, can't
  // get a check-in QR text, and just clutters the roster. Skip the row
  // outright — order_items still records the seat with rider_email/etc.
