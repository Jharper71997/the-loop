...
// EXCEPT the cron keys (WAIVER_NUDGE_CRON, RIDE_FEEDBACK_CRON), which default
// FALSE so a newly-deployed cron can't start texting riders before anyone
// asked it to. This way introducing a new toggle never silently suppresses a
