...
export const TONES = {
  void: '#121214',      // deepest — for photo sections where the image carries
  base: '#17171a',      // the marketing base
  raised: '#1e1e22',    // one step up, for content-dense bands
  panel: '#26262b',     // highest, for the merch / product band
}
