...
export const SPONSORS = [
  ...
  { name: "Joya's Detailing Services", tag: 'Auto detailing', logo: '/brand/sponsors/joyas-detailing.jpg', url: 'https://www.instagram.com/joyasdetailingservicesllc/', blurb: 'Veteran-owned auto detailing, restoration, and customization. Precision isn’t optional, it’s standard.' },
  ...
  { name: 'No Limit Pub Poker', tag: 'Pub poker league', logo: '/brand/sponsors/no-limit-poker.png', url: 'https://www.nolimitpubpoker.com/', blurb: 'Free points-based Texas Hold’em league playing for prizes and tournament seats. Free to play, no purchase necessary.' },
